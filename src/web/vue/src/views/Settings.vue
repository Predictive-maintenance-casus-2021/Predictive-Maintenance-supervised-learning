...
export default {
  ...
  methods: {
    train() {
      this.model_message =
        "Momenteel wordt het model getraind, dit kan even duren...";
      ...
      this.$http
        ...
        .then(() => {
          this.model_message =
            "De modellen zijn getraind, de backend wordt herstart...";
        })
        .catch(() => {
          this.model_message =
            "Er is een error tijdens het trainen van de nieuwe modellen, probeer dit opnieuw...";
        })
        .finally(() => {
          setTimeout(() => {
